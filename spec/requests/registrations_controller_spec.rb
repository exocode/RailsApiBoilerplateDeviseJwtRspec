...
describe '/auth', type: :request do
  ...
  context 'GET /auth' do
    ...
    context 'with valid params' do
      ...
      before(:each) { post url, params: { user: { email: Faker::Internet.email, password: 'password', password_confirmation: 'password' } } }
    ...
    context 'with invalid email' do
      ...
      before(:each) { post url, params: { user: { email: 'some.email@nodomain', password: 'password', password_confirmation: 'password' } } }
    ...
    context 'with invalid password_confirmation' do
      ...
      before(:each) { post url, params: { user: { email: Faker::Internet.email, password: 'password', password_confirmation: 'wrongpassword' } } }
    ...
    context 'with too short password' do
      ...
      before(:each) { post url, params: { user: { email: Faker::Internet.email, password: 'pass', password_confirmation: 'pass' } } }
